...
#PBS -o 03_exabayes_unpartitioned.stdout
#PBS -e 03_exabayes_unpartitioned.stderr
#PBS -N 03_exabayes_unpartitioned
...
cd $workdir
mpirun -np $procs exabayes -f $phylip -n $phylip_Continued -r $phylip -c config.nexus
